...
class Login extends React.Component {
  handleLogUser = e => {
    ...
    this.props.initialRoute !== undefined
      ? this.props.history.push(this.props.initialRoute)
  ...
  render() {
    ...
    if (loggedUserId) {
      loginPage = (
        <button
          onClick={() => this.handleLogUser(undefined)}
...
function mapStateToProps({ getUsers, saveLoggedUser, addRoute }) {
